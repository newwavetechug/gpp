...
<div class="widget">
    <div class="widget-title">
        <h4><i class="icon-reorder"></i>&nbsp;<?=(!empty($form_title)? $form_title : '') ?></h4>
            <span class="tools">
    ...
    <div class="widget-body" >
        <!-- BEGIN FORM-->
        <form id="bid-invitation-approval-form" action="<?=base_url() . 'bids/view_bid_invitation/v/doc' . ((!empty($i))? '/i/'.$i : '' )?>" enctype="multipart/form-data" method="post" target="_new" class="form-horizontal">
            ...
            <?php if(($formdata['isapproved'] == 'N' || empty($formdata['cc_approval_date'])) && check_user_access($this, 'publish_invitation_for_bids') && empty($v)): ?>
