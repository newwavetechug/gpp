  ...
  */
  ...
  <div class=" row-fluid span12">
    ...
    $varible = (!empty($lots)) ? '<>*ifbslot' : '' ;
      ?>
  <form action="#" class="form-horizontal" id="bidreceipt" name="bidreceipt"  data-type="newrecord"  data-cheks="pdename<>pdecode" data-check-action="<?=base_url();?>receipts/save_bidreceipt<?='/'.$i; ?>" data-action="<?=base_url();?>receipts/save_bidreceipt<?= '/'.$i; ?>"    data-elements="datesubmitted<>*receivedby<>*serviceprovider<>*nationality<>*procurementrefno<>*readoutprice<>*currency<?=$varible; ?>" >
             <div class="span12">
             <div class="row-fluid">
             <div class="control-group">
               ...
               <input type="hidden" value="<?=$rowa['id']; ?>" class="bidid" id="bidid"" name="bidid"" />
               </label>
    ...
    Yes/No </label>
             ...
             <input type='text' data-url="<?=base_url().'receipts/searchprovider/'.$i;?>" data-cheks="providernames" class="span8 serviceprovider" value="<?=$serviceprovider; ?>" name="serviceprovider" id="serviceprovider" onFocusOut="javascript:chckprovider(this.value);"  onBlur="javascript:chckprovider(this.value);"  />
...
<br/>
              ...
              <label class="control-label">Date Submitted</label>
               <div class="controls">
                                             <div class="input-append date date-picker span4" data-date="<?=Date('d-m-Y'); ?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
                                                 <input class=" m-ctrl-medium date-picker datepicker span10 datesubmitted"   type="text" value="<?=Date('d-m-Y') ?>" id="datesubmitted"  name="datesubmitted" /><span class="add-on"><i class="fa fa-calendar"></i></span>
        </div>
        </div>
        </div>
        </div>
  ...
  <br/>
            ...
            <div class="control-group">
              ...
              <div class="row-fluid"> &nbsp; &nbsp;
              <button type="submit" name="save" value="save" class="btn blue"><i class="fa fa-ok"></i> Add Bid</button>
              &nbsp; &nbsp;&nbsp;
